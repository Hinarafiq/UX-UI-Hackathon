...
export default function Header () {
    return(
        <div className="w-full h-[80px] bg-[#FBEBB5]">
            {/* Header Components */}
            <ul className="w-[430px] h-[24px] pt-[28px] gap-14 ml-[405px] leading-6 flex bg-[#FBEBB5] text-[#000000] font-medium">
            ...
            <ul className="w-[247px] h-[28px] flex ml-[993px] bg-[#FBEBB5] gap-12">
